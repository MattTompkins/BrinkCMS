                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/all-articles">All Articles</a>
                                    <a class="nav-link" href="/admin/create-article">Create Article</a>
                                    <a class="nav-link" href="/admin/my-articles">My Articles</a>
                                </nav>
                            </div>
