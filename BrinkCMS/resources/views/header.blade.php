                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-xl-8 col-lg-4 col-md-4 col-12">
                            <div class="wrapper d-block d-sm-flex flex-wrap align-items-center justify-content-center justify-content-md-start">
                                <div class="logo">
                                    <a href="index.html">
                                        <img class="dark-logo" src=" {{ asset('images/logo/logo-black.png') }}" alt="Blogar logo">
                                        <img class="light-logo" src=" {{ asset('images/logo/logo-white2.png') }}" alt="Blogar logo">
                                    </a>
                                </div>
                        ...
                        <span data-text="Post Layout Five">Post Layout Five</span>
                                    ...
                                    <span data-text="Gadgets">Gadgets</span>
                                                        ...
                                                        <div class="axil-vertical-nav-content">
                                                            <!-- Start One Item  -->
                                                            <div class="axil-vertical-inner tab-content" id="tab1" style="display: none;">
                                                                            ...
                                                                            <div class="content-block image-rounded">
                                                                                <div class="post-thumbnail mb--20">
                                                                                    <a href="post-details.html">
                                                                                        <img class="w-100" src=" {{ asset('images/others/mega-post-01.jpg') }}" alt="Post Images">
                                                                                    </a>
                                                                                </div>
                                                            ...
                                                            <span data-text="DESIGN">DESIGN</span>
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="content-block image-rounded">
                                                                                <div class="post-thumbnail mb--20">
                                                                                    <a href="post-details.html">
                                                                                        <img class="w-100" src=" {{ asset('images/others/mega-post-02.jpg') }}" alt="Post Images">
                                                                                    </a>
                                                                                </div>
                                                                                <div class="post-content">
                                                                                    <div class="post-cat">
                                                            ...
                                                            <span data-text="CREATIVE">CREATIVE</span>
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="content-block image-rounded">
                                                                                <div class="post-thumbnail mb--20">
                                                                                    <a href="post-details.html">
                                                                                        <img class="w-100" src=" {{ asset('images/others/mega-post-03.jpg') }}" alt="Post Images">
                                                                                    </a>
                                                                                </div>
                                                                                <div class="post-content">
                                                                                    <div class="post-cat">
                                                            ...
                                                            <span data-text="TRAVEL">TRAVEL</span>
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="content-block image-rounded">
                                                                                <div class="post-thumbnail mb--20">
                                                                                    <a href="post-details.html">
                                                                                        <img class="w-100" src=" {{ asset('images/others/mega-post-04.jpg') }}" alt="Post Images">
                                                                                    </a>
                                                                                </div>
                                                                                <div class="post-content">
                                                                                    <div class="post-cat">
                                                            ...
                                                            <!-- Start One Item  -->
                                                            <div class="axil-vertical-inner tab-content" id="tab2" style="display: block; opacity: 1;">
                                                                <div class="axil-vertical-single">
                                                                    <div class="row">
                                                            ...
                                                            <!-- Start One Item  -->
                                                            <div class="axil-vertical-inner tab-content" id="tab3" style="display: none;">
                                                                <div class="axil-vertical-single">
                                                                    <div class="row">
                                                            ...
                                                            <!-- Start One Item  -->
                                                            <div class="axil-vertical-inner tab-content" id="tab4" style="display: none;">
                                                                <div class="axil-vertical-single">
                                                                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-8 col-md-8 col-12">
                            <div class="header-search d-flex flex-wrap align-items-center justify-content-center justify-content-md-end">
                                ...
                                <ul class="metabar-block">
                                    ...
                                    <li><a href="#"><img src="https://cdn.britannica.com/55/117055-050-8DEEB41A/Wood-pigeon.jpg" alt="Author Images"></a></li>
                                    @else 
